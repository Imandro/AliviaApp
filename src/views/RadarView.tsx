    ...
    <div className="fade-in flex flex-col gap-4">
      ...
      <div className="glass-card flex flex-col gap-2">
        ...
        <p className="body-standard" style={{ fontSize: '11.5px', opacity: 0.7 }}>
          Cada pétalo representa una emoción (de ◌ luna nueva, sin luz, a ● luna llena, en paz). Cuanto más crece un pétalo, más días la viviste en el periodo elegido. El polígomo azul conecta tus emociones para mostrar tu paisaje emocional completo.
        </p>
      </div>
    </div>
  );
