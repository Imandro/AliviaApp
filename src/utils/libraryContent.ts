...
export const GUIDES: Record<string, GuideContent> = {
  ...
  l1: {
    ...
    blocks: [
      ...
      st('✂️', 'Acota el drama a 10 minutos', 'Permítete preocuparte un bloque de 10 minutos al día. Fuera de él, si vuelve el pensamiento, dile: "te atiendo en mi hora de drama".'),
  ...
  l2: {
    minutes: 4,
    blocks: [
      intro('Tu mente no necesita una semana de spa: necesita 18 minutos bien usados al día. ⏱️'),
      ...
      st('☝️', '1 minuto por hora (regla del pulgar)', 'Cada hora, párate, mira lejos 20 segundos y nombra en tu cabeza 3 cosas que ves. Devuelve la mente al cuerpo.'),
  ...
  l3: {
    ...
    blocks: [
      ...
      st('🕵️', 'Pregúntale a tu tristeza', '¿Qué me está diciendo esta tristeza? ¿Qué necesita mi vida que no está teniendo? La tristeza es información, no error del sistema.'),
  ...
  l4: {
    ...
    blocks: [
      ...
      st('❄️', 'Enfría el sistema', 'Agua fría en cara y muñecas, o un hielo en la mano. El frío es el botón de "apagado de emergencia" físico que el cerebro no puede ignorar.'),
      st('🌬️', 'Respira 4-7-8', 'Inhala 4 segundos, sostén 7, exhala 8. Repite 4 veces. La exhalación larga es una instrucción directa al cuerpo: "baja las revoluciones".'),
  ...
  l6: {
    ...
    blocks: [
      ...
      st('🛡️', 'Tres círculos', 'Dibuja mentalmente: lo que depende de ti, lo que depende de ellos, y lo que no depende de nadie. Solo ocúpate de tu círculo. El resto: obsérvalo desde lejos.'),
      ...
      end('No puedes cambiar el ambiente si no te cambias de posición dentro de él. 🕊️'),
    ],
  },
  ...
  l7: {
    minutes: 3,
    blocks: [
      intro('Dormir no es "perder tiempo": es el mantenimiento nocturno donde se arregla tu cerebro. 🛠️'),
      ...
      st('🏷️', 'La técnica del "renombrado"', 'Si te desvelas, no pienses "no puedo dormir" (pánico). Piensa "estoy descansando, mi cuerpo sabe". Y usa protocolo 4-7-8 si el cuerpo se acelera.'),
      ...
      end('Dormir bien es el 50% de tu salud emocional en el menú del día. 🛏️'),
    ],
  },
  ...
  l12: {
    ...
    blocks: [
      ...
      st('🗣️', 'Dilo una vez, claramente', 'Pon tu límite con nombre: "no me escribas cuando me enoje", "no reviso más mi teléfono para ti". Si se repite, no es accidente: es decisión.'),
      ...
      end('Amor no es quien te persigue: es quien te deja ser y se queda igual. 🕊️'),
    ],
  },
  ...
  l13: {
    minutes: 5,
    blocks: [
      intro('Terminar una relación tóxica no se "decide": se planifica. Aquí tienes el plan paso a paso. 🗺️'),
  ...
  l14: {
    ...
    blocks: [
      ...
      st('🗂️', 'La regla de los 3 tarros', 'Gasto (80%), ahorro (10%), felicidad/emergencia (10%). Tres bolsas mentales evitan la culpa y el descontrol.'),
      st('⏸️', 'La noche de gracia (24h)', 'Compras de más de X (pon tu precio, ej. $10): espera 24h. El impulso muere y el bolsillo vive.'),
  ...
  l15: {
    minutes: 3,
    blocks: [
      intro('Hay plata "regalada" esperando jóvenes que sepan dónde pedir. Tu trabajo: conocer el mapa. 🗺️'),
  ...
  l16: {
    ...
    blocks: [
      ...
      st('🎛️', 'Hipervigilancia, apágalo', 'Si en tu casa hay gritos o tensión, tu cuerpo se queda en "alerta de incendio". Entrena pausas: aunque suene feo, tú respira lento y baja el volumen interno.'),
      ...
      st('🗓️', 'Plan de salida 1.0', 'Aunque sea en un año: un plan silencioso (estudio, trabajo, beca) te da esperanza con hormigón. Papel y lápiz: ¿qué puedo construir fuera de casa?'),
  ...
  l17: {
    ...
    blocks: [
      ...
      st('🧑‍⚕️', 'El tratamiento funciona', 'Terapia + (a veces) medicación = el combo que más funciona. No es "para locos": es para gente que quiere su vida de vuelta.'),
  ...
  l18: {
    minutes: 4,
    blocks: [
      intro('Ataque de pánico = el cuerpo gritando "¡PELIGRO!" cuando no hay león. Es horrible, no es peligroso, y se acaba. ⏱️'),
      ...
      st('🌬️', 'Exhala antes que la ola', 'Inhala 4, exhala 8 (no sostengas: la exhalación larga es tu llave). La hiperventilación es el motor del miedo: exhalar lo desactiva.'),
      ...
      end('Pánico: horrible, inocuo, pasajero. Con protocolo, hasta los atacas de vuelta. 🌩️'),
    ],
  },
  ...
  l19: {
    ...
    blocks: [
      ...
      st('🕳️', 'La regla del hueco', 'La adicción no da placer: cubre un hueco que tienes abajo (miedo, soledad, estrés). Si solo tapas el hueco, vuelve. El trabajo grande es el fondo.'),
      ...
      end('Recaer no borra el avance: la recuperación se camina con recaídas en el bolsillo, no con ellas al frente. 🏔️'),
    ],
  },
  ...
  l20: {
    minutes: 3,
    blocks: [
      intro('El apoyo real en Centroamérica existe y es GRATIS. Lo difícil no es encontrarlo: es el primer paso. Este mapa es tu abrebocas. 🗺️'),
      st('☎️', 'Líneas y centros', 'En tu pantalla SOS tienes líneas de crisis gratuitas de tu país 24/7. También: hospitales públicos (servicio de salud mental), iglesias y fundaciones con programas de adicciones.'),
      ...
      st('#️⃣', 'Chat y comunidad', 'Algunas ONG (ej. programa Jóvenes de tu ministerio de salud) tienen líneas de WhatsApp. Pregunta en tu centro de salud por "programa de adicciones de jóvenes".'),
  ...
  l22: {
    minutes: 4,
    blocks: [
      intro('Pedir ayuda cuando piensas en no seguir: el acto más valiente que existe. Aquí va el guion, palabra por palabra. 🎙️'),
